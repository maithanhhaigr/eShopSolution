...
##Lession 22:
- Install ...JwtBearer
- Protected Api Swagger (Add Authorazation to Swagger)
...
#Lession 28:
- Git branches: feature/28_create_user
- Create user
- Create BaseRequest
- Add Session in Asp.Net Core

##Lession 29:
- Git branches: feature/29_update_user
- Update user

##Lession 30:
- Git branches: feature/30_user_paging
- User Paging
- PagedResultBase
- View component Asp.Net Core

##Lession 31:
- Git branches: feature/31_user_delete
- User Delete

##Lession 32:
- Git branches: feature/32_user_search
- User Search

##Lession 33:
- Git branches: feature/33_temp_data
- TempData
- https://getbootstrap.com

##Lession 34:
- Git branches: feature/34_role_assign
- Role Assign

##Lession 35
- Git branches: feature/35_setting_language
- Setting Language, Change language
- Use ViewComponent
- Use BaseApiClient, SubClass => Homework
